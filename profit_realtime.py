...
while True:
    ...
    print(f"Monthly profit = ${24*30.5*(usd_per_hour-pool_fee-electric_cost):.2f}")
    with open("profit_now","w") as output:
        output.write(f"${24*30.5*(usd_per_hour-pool_fee-electric_cost):.2f}/mo")
